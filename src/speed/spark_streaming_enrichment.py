...
Reads from Kafka, joins with route mapping, outputs enriched stream
"""
from pyspark.sql import SparkSession
from pyspark.sql.functions import (
    from_json, col, expr, when, lit, 
    udf, struct, to_json, current_timestamp,
    regexp_extract, coalesce, broadcast
)
...
from src.speed.route_mapping import (
    INDIAN_AIRLINES, INDIAN_AIRPORTS, 
    generate_route_mapping_rows
)
...
# Kafka topics
KAFKA_INPUT_TOPIC = KAFKA_TOPIC_INDIA
KAFKA_OUTPUT_TOPIC = "aviation-enriched-states"
